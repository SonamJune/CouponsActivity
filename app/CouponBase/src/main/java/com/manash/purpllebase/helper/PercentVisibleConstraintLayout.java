...
public class PercentVisibleConstraintLayout extends ConstraintLayout {
    ...
    public PercentVisibleConstraintLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PercentVisibleConstraintLayout(Context context) {
        super(context);
    }
