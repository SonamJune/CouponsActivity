...
import com.manash.purpllebase.helper.ApplicationStatus;
import com.manash.purpllebase.helper.PurplleTrace;
import com.manash.purpllebase.helper.Tls12SocketFactory;
...
//                            }
//
//                            if(PurpllePrefManager.getInstance(PurplleApplication.getAppContext()).GLOBAL.getBoolean(PurplleApplication.getAppContext().getString(com.manash.purpllebase.R.string.is_clevertap_enabled), true)) {
